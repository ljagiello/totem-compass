...
func (n *Node) Update(now time.Time) error {
	...
	// The ring goes with them. It holds the share of the last download,
	// so an update starting after one that reached 80% opened showing
	// four fifths of a ring lit for a file it had not asked for yet.
	n.leds.SetProgress(0)
