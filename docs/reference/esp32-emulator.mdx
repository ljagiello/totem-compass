...
**Hardware-tested** on 2026-09-19: an ESP32-D0WD-V3 bonded with a Totem on firmware 5.0.3
through the normal Touch Crystal pairing. The Totem then unicast its status to the emulator
every second, and it acknowledged every status frame the emulator sent.
...
| `heading <deg>` | compass azimuth to report, 0-359 |
...
magnetometer, motion sensor and power chip where they exist.
